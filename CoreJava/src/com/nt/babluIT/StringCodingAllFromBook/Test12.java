...
public class Test12 {
	public static void main(String[] args) {
		...
		String[] sa16 = s2.split("a");
		System.out.println(sa16.length);
		System.out.println(Arrays.toString(sa16));
